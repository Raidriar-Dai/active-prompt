...
python inference.py --dataset="gsm8k" --model="text-davinci-002" --method="active_cot" --qes_limit=10 \
    --prompt_path="./inference_prompts/gsm8k_k=10" --random_seed=42 --multipath=1 --temperature=0.7 --api_time_interval=15
